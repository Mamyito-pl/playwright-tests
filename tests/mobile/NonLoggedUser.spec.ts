...
test.describe('Testy niezalogowanego użytkownika', async () => {
  ...
  test('M | Alkoholowy produkt jest jako zablurowany', async ({ page }) => {
    ...
    const searchedProductBlur = page.locator('div[data-sentry-element="TabletContent"] div[data-testid="search-results"] div[data-sentry-component="ProductCard"] div[data-sentry-element="Wrapper"]').first();
    const attachedAttribute = page.locator('div[data-sentry-element="TabletContent"] div[data-testid="search-results"] div[data-sentry-component="ProductCard"] img[alt="poniżej 18 lat"]').first();
