...
test.describe('Testy dane do faktury', async () => {
  ...
  test.describe('Faktura firmowa', async () => {
    ...
    test('M | Możliwość dodania danych do faktury firmowej', { tag: ['@ProdSmoke', '@Smoke'] }, async ({ page }) => {
    ...
    test('M | Możliwość edycji danych do faktury firmowej', { tag: ['@ProdSmoke', '@Smoke'] }, async ({ page, addCompanyInvoiceAddressDelivery }) => {
    ...
    test('M | Możliwość ustawienia głównych danych do faktury firmowej', { tag: ['@Prod', '@Beta', '@Test'] }, async ({ page, addCompanyInvoiceAddressDelivery }) => {
    ...
    test('M | Możliwość usunięcia danych do faktury firmowej', { tag: ['@Prod', '@Beta', '@Test'] }, async ({ page, addCompanyInvoiceAddressDelivery }) => {
  ...
  test.describe('Faktura imienna', async () => {
    ...
    test('M | Możliwość dodania danych do faktury imiennej', { tag: ['@ProdSmoke', '@Smoke'] }, async ({ page }) => {
    ...
    test('M | Możliwość edycji danych do faktury imiennej', { tag: ['@ProdSmoke', '@Smoke'] }, async ({ page, addPersonalInvoiceAddressDelivery }) => {
    ...
    test('M | Możliwość ustawienia głównych danych do faktury imiennej', { tag: ['@Prod', '@Beta', '@Test'] }, async ({ page, addPersonalInvoiceAddressDelivery }) => {
    ...
    test('M | Możliwość usunięcia danych do faktury imiennej', { tag: ['@Prod', '@Beta', '@Test'] }, async ({ page, addPersonalInvoiceAddressDelivery }) => {
