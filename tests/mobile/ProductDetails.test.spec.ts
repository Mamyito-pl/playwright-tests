...
test.describe('Testy szczegółów produktu', async () => {
  ...
  test('M | Możliwość wyświetlenia informacji opakowania o produkcie', { tag: ['@Prod', '@Beta'] }, async ({ page, searchProduct }) => {
